                ...
                return oneLargeControl ??
                       (oneLargeControl =
                        new RibbonGroupTemplate(
                            "DeutscheBank.SharePoint.LNAR.Framework.Ribbon.Templates.OneLargeControl",
                            @"<GroupTemplate Id=""DeutscheBank.SharePoint.LNAR.Framework.Ribbon.Templates.OneLargeControl"">
                            <Layout Title=""Large"">
                                <Section Type=""OneRow"">
                                    <Row>
        ...
        public static RibbonGroupTemplate TwoLargeControls
        {
            get
            {
                return twoLargeControls ??
                       (twoLargeControls =
                        new RibbonGroupTemplate(
                            "DeutscheBank.SharePoint.LNAR.Framework.Ribbon.Templates.TwoLargeControls",
                            @"<GroupTemplate Id=""DeutscheBank.SharePoint.LNAR.Framework.Ribbon.Templates.TwoLargeControls"">
                            <Layout Title=""Large"">
                                <Section Type=""OneRow"">
                                    <Row>
                                        <ControlRef TemplateAlias=""c1"" DisplayMode=""Large"" />
        ...
        public static RibbonGroupTemplate ThreeLargeControls
        {
            get
            {
                return threeLargeControls ??
                       (threeLargeControls =
                        new RibbonGroupTemplate(
                            "DeutscheBank.SharePoint.LNAR.Framework.Ribbon.Templates.ThreeLargeControls",
                            @"<GroupTemplate Id=""DeutscheBank.SharePoint.LNAR.Framework.Ribbon.Templates.ThreeLargeControls"">
                            <Layout Title=""Large"">
                                <Section Type=""OneRow"">
                                    <Row>
                                        <ControlRef TemplateAlias=""c1"" DisplayMode=""Large"" />
        ...
        public static RibbonGroupTemplate FourLargeControls
        {
            get
            {
                return fourLargeControls ??
                       (fourLargeControls =
                        new RibbonGroupTemplate(
                            "DeutscheBank.SharePoint.LNAR.Framework.Ribbon.Templates.FourLargeControls",
                            @"<GroupTemplate Id=""DeutscheBank.SharePoint.LNAR.Framework.Ribbon.Templates.FourLargeControls"">
                            <Layout Title=""Large"">
                                <Section Type=""OneRow"">
                                    <Row>
                                        <ControlRef TemplateAlias=""c1"" DisplayMode=""Large"" />
        ...
        public static RibbonGroupTemplate FiveLargeControls
        {
            get
            {
                return fiveLargeControls ??
                       (fiveLargeControls =
                        new RibbonGroupTemplate(
                            "DeutscheBank.SharePoint.LNAR.Framework.Ribbon.Templates.FiveLargeControls",
                            @"<GroupTemplate Id=""DeutscheBank.SharePoint.LNAR.Framework.Ribbon.Templates.FiveLargeControls"">
                            <Layout Title=""Large"">
                                <Section Type=""OneRow"">
                                    <Row>
                                        <ControlRef TemplateAlias=""c1"" DisplayMode=""Large"" />
        ...
        public static RibbonGroupTemplate Flexible
        {
            get
            {
                return flexible ??
                       (flexible =
                        new RibbonGroupTemplate(
                            "DeutscheBank.SharePoint.LNAR.Framework.Ribbon.Templates.Flexible",
                            @"<GroupTemplate Id=""DeutscheBank.SharePoint.LNAR.Framework.Ribbon.Templates.Flexible"">
                                <Layout Title=""Large"">
        ...
        public static RibbonGroupTemplate Flexible2
        {
            get
            {
                return flexible2 ??
                       (flexible2 =
                        new RibbonGroupTemplate(
                            "DeutscheBank.SharePoint.LNAR.Framework.Ribbon.Templates.Flexible2",
                            @"<GroupTemplate Id=""DeutscheBank.SharePoint.LNAR.Framework.Ribbon.Templates.Flexible2"">
        ...
        public static RibbonGroupTemplate TwoRowsFourMedium
        {
            get
            {
                return twoRowsFourMedium ??
                       (twoRowsFourMedium =
                        new RibbonGroupTemplate(
                            "DeutscheBank.SharePoint.LNAR.Framework.Ribbon.Templates.TwoRowsFourMedium",
                            @"<GroupTemplate Id=""DeutscheBank.SharePoint.LNAR.Framework.Ribbon.Templates.TwoRowsFourMedium"">
                                <Layout Title=""Large"">
                                  <Section Type=""TwoRow"">
                                    <Row>
            ...
            get
            {
                return threeRowsThreeMedium ??
                       (threeRowsThreeMedium =
                        new RibbonGroupTemplate(
                            "DeutscheBank.SharePoint.LNAR.Framework.Ribbon.Templates.ThreeRowsThreeMedium",
                            @"<GroupTemplate Id=""DeutscheBank.SharePoint.LNAR.Framework.Ribbon.Templates.ThreeRowsThreeMedium"">
                                <Layout Title=""Large"">
        ...
        internal static RibbonGroupTemplate ManageViewsGroup
        {
            get
            {
                return manageViewsGroup ??
                       (manageViewsGroup =
                        new RibbonGroupTemplate(
                            "DeutscheBank.SharePoint.LNAR.Framework.Ribbon.Templates.ManageViewsGroup",
                            @"<GroupTemplate Id=""DeutscheBank.SharePoint.LNAR.Framework.Ribbon.Templates.ManageViewsGroup"">
                                <Layout Title=""LargeMedium"">
                                  <OverflowSection Type=""OneRow"" TemplateAlias=""c1"" DisplayMode=""Large""/>
                                  <OverflowSection Type=""ThreeRow"" TemplateAlias=""c2"" DisplayMode=""Medium""/>
                                  <Section Type=""ThreeRow"">
