...
namespace NAPAS.Portal.Common.Framework.Core.WebControls
{
    public class BaseUserControl : UserControl
    {
        ...
        protected const string RibbonCustomizationScript = @"
            var RibbonCustomization = RibbonCustomization || {};
            ...
            RibbonCustomization.PageComponent.prototype = {
                ...
                getGlobalCommands: function () {
                    return getGlobalCommandsTemplate;
                },
...
//        }
        ...
        public string SetSessionString(string sessionName, string sessionValue,bool overwrite)
        {
            if(overwrite)
