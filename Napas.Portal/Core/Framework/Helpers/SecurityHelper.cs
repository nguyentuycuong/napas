...
namespace NAPAS.Portal.Common.Framework.Core.Helpers
{
    ...
    public static class SecurityHelper
    {
        ...
        /// <summary>
        /// Clear role assignment of principal from  list
        /// </summary>
        /// <param name="web">
        /// </param>
        /// <param name="principal">
        /// </param>
        public static void ClearRoleAssignmentForList(SPList list, SPPrincipal principal)
        {
        ...
        public static bool SetAllowUnsafeUpdates(SPWeb web)
        {
        ...
        public static void RollbackAllowUnsafeUpdates(SPWeb web, bool status)
        {
            if (status)
            {
