...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CareerResult.ascx.cs" Inherits="Napas.Portal.ControlTemplates.CareerResult" %>
                ...
                <div style="text-align: justify">
                    <div class="information-recruitment">
                        <h1 class="heading">
                            ...
                            <asp:Literal runat="server" Text="<%$Resources:napas.resource,RecruitmentResults%>" />
                        </h1>
