...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="nap_tai_khoan_dich_vu_tra_truoc.ascx.cs" Inherits="Napas.Portal.ControlTemplates.nap_tai_khoan_dich_vu_tra_truoc" %>
    ...
    <div class="middle-inner">
        <div class="container">
            <div class="sitemap">
                ...
                <span>|</span>
                <SharePoint:SPLinkButton runat="server" NavigateUrl='<%$Resources:napas.resource,UrlTopup%>' CssClass="current">
            ...
            <div class="cols">
                ...
                <div class="colright">
                    <div class="shopping-online">
                        <h2 class="title title-old"><i class="fa fa-caret-right" aria-hidden="true"></i><asp:Literal runat="server" ID="ltHeader"></asp:Literal> </h2>
