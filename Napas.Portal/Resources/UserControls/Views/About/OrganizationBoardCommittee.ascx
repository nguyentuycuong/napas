...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OrganizationBoardCommittee.ascx.cs" Inherits="Napas.Portal.ControlTemplates.OrganizationBoardCommittee" %>
    ...
    <div class="middle-inner">
        <div class="container">
            <div class="sitemap">
                ...
                <span>|</span>
                <SharePoint:SPLinkButton runat="server" NavigateUrl='<%$Resources:napas.resource,UrlExecutiveCommittee%>' CssClass="current">
                ...
                <div class="co-cau">
                    <div class="colright">
                        <h2 class="title">
                            ...
                            <asp:Literal runat="server" Text="<%$Resources:napas.resource,ExecutiveCommittee%>"></asp:Literal>
                        </h2>                        
