...
{
    public partial class OrganizationBoardExecutive : UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    division = Constants.OrgNameEn.ExecutiveBoard;
                    buttonName = "Detail";
                }
                else
                {
                    division = Constants.OrgNameVn.ExecutiveBoard;
                    buttonName = "Chi tiết";
                }

                AboutBo aboutBo = new AboutBo(SPContext.Current.Web);
                Organization retOrg = new Organization(SPContext.Current.Web);
                ...
                pageTitle += " - " + HttpContext.GetGlobalResourceObject("napas.resource", "ExecutiveBoard").ToString();
                ...
                for (int loop = 0; loop < items.Count; loop++)
                {
                    ...
                    PopupText += string.Format(@"<div class='modal my-modal my-modal-organize fade' id='modal-info-organize{0}' tabindex='-1' role='dialog' aria-labelledby='mySmallModalLabel'>
