...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OrganizationBoardExecutive.ascx.cs" Inherits="Napas.Portal.ControlTemplates.OrganizationBoardExecutive" %>
    ...
    <div class="middle-inner">
        <div class="container">
            <div class="sitemap">
                ...
                <span>|</span>
                <SharePoint:SPLinkButton runat="server" NavigateUrl='<%$Resources:napas.resource,UrlExecutiveBoard%>' CssClass="current">
                ...
                <div class="co-cau">
                    <div class="colright">
                        <h2 class="title">
                            ...
                            <asp:Literal runat="server" Text="<%$Resources:napas.resource,ExecutiveBoard%>"></asp:Literal>
                        </h2>                        
